...
struct BotData {
    public static let friendByName = [
        "CapeMountainBot": Friend(ID: "capemountainbot@sparkbot.io", name: "Museo di Capodimonte", location: CLLocation(latitude: 37.33155713, longitude: -122.03071078), locationName: "Capodimonte, Napoli", image: UIImage(named: "museoDiCapodimonte"), imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Reggia_di_Capodimonte_1.JPG/260px-Reggia_di_Capodimonte_1.JPG"),
        ...
        "SanGirolamo": Friend(ID: "sangirolamo@sparkbot.io", name: "San Girolamo", location: CLLocation(latitude: 40.867282, longitude: 14.250979), locationName: "Capodimonte, Napoli", image: UIImage(named: "SanGirolamo"), imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Reggia_di_Capodimonte_1.JPG/260px-Reggia_di_Capodimonte_1.JPG"),
        "GiuseppeGaribaldi": Friend(ID: "giuseppeGaribaldi@sparkbot.io", name: "Giuseppe Garibaldi", location: CLLocation(latitude: 37.331558, longitude: -122.03071078), locationName: "Piazza Garibaldi, Napoli", image: UIImage(named: "SanGirolamo"), imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Reggia_di_Capodimonte_1.JPG/260px-Reggia_di_Capodimonte_1.JPG")
    ]
}
