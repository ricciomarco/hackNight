...
struct BotData {
    public static let friendByName = [
        "CapeMountainBot": Friend(ID: "capemountainbot@sparkbot.io", name: "Museo di Capodimonte", location: CLLocation(latitude: 40.867021, longitude: 14.250571), locationName: "Capodimonte, Napoli", image: UIImage(named: "museoDiCapodimonte"), imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Reggia_di_Capodimonte_1.JPG/260px-Reggia_di_Capodimonte_1.JPG"),
        "StatuaDelGigante": Friend(ID: "statuadelgigante@sparkbot.io", name: "Statua del Gigante", location: CLLocation(latitude: 40.869773, longitude: 14.250562), locationName: "Capodimonte, Napoli", image: UIImage(named: "StatuaGigante"), imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Reggia_di_Capodimonte_1.JPG/260px-Reggia_di_Capodimonte_1.JPG"),
        "SanGirolamo": Friend(ID: "sangirolamo@sparkbot.io", name: "San Girolamo", location: CLLocation(latitude: 40.873282, longitude: 14.250979), locationName: "Capodimonte, Napoli", image: UIImage(named: "SanGirolamo"), imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Reggia_di_Capodimonte_1.JPG/260px-Reggia_di_Capodimonte_1.JPG"),
        "GiuseppeGaribaldi": Friend(ID: "giuseppeGaribaldi@sparkbot.io", name: "Giuseppe Garibaldi", location: CLLocation(latitude: 40.852284, longitude: 14.268620), locationName: "Piazza Garibaldi, Napoli", image: UIImage(named: "Garibaldi"), imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Reggia_di_Capodimonte_1.JPG/260px-Reggia_di_Capodimonte_1.JPG")
    ]
}
